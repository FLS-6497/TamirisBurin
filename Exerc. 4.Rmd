...
# Define estratégia de separação da amostra
```{r}
resampling <- rsmp("holdout", ratio = 0.7)
...
#Calcular o z score, pega cada, divide pela média e pelo desvio padrão. Aí fica normalizada. 
...
regiao, semiárido, estado, calcular a variável de comparecimento. Diferentes bases de treino. Usem, criem e tranformem variáveis.

#d) Transformações
Transforme a variável pib_total para que ela fique estandardizada (vale ser criativo e explorar outras variáveis do banco).
já deu a resposta. Transformar em log, antes, a variável.
