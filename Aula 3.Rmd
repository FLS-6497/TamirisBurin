...
#depois cria uma função para encapsular tudo, depois controlar o tamanho da base, depois vamos mudar o classificador, para a comparação de modelos não é  muito

#temos que comparar os modelos na mesma base de treino. o ideal é comparar os algorítmos na mesma base de treino.
