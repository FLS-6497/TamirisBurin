...
pred3$confusion
predicao <- pred3$score(msr("classif.logloss"))
predicao
```
...
### 9. Predicao para base de validacao com discursos sem indicação de autoria
...
predtamirisburin <- modeloxgboostprop$predict_newdata(discursosvalidacaobow)
predtamirisburin
```
