...
#4. min_termfreq: estipula um numero mínimo valores minimo de frequencias do termo em todos os documentos.
...
Testamos a acuracia do Extreme Gradient Boost na amostra de validação:
